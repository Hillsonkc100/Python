# Numbes are the immutable datatypes in python
...
# Integers are the numbe without decimal values
...
# Float
# float() function is a built-in function to create a float object
